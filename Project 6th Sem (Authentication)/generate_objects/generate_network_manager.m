function [network_managers] = generate_network_manager(sc, network_manager_data,geo_satellites,times,city,ground_coords) 
    % Initialize an empty array
    network_managers = [];
   
    % Loop through ground station data
    for i = 1:size(network_manager_data, 1)
        current_nm = network_manager(sc,city(i), ...
            ...
            0,geo_satellites,i,times,ground_coords(i,:));
