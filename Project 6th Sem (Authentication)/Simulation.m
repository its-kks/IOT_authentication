...
% load ground_station data in ground_station_data variable

load('ground_station_data.mat')
...
% Tracking time passed in minutes
time_min = -60;
...
while sc.SimulationTime ~= sc.StopTime
    ...
    for nm_in=1:size(network_managers,1)
        for leo_in=1:size(leo_satellites,1)
            ...
            % Chekcing if new satellites has come in range
